...
public class BootstrapTableTests {
    ...
    public void deleteRow(){
        ...
        List<WebElement> lista1 = this.driver
                .findElements(By.xpath("//*[@class='table table-hover table-responsive']/tbody/tr"));
        this.driver.findElement(By.id("del")).click();
        this.wait.until(ExpectedConditions.invisibilityOfElementLocated(By.id("del")));
        List<WebElement> lista2 = this.driver
                .findElements(By.xpath("//*[@class='table table-hover table-responsive']/tbody/tr"));
        Assert.assertFalse(((List<?>) lista1).size() == (lista2.size() + 1),
                "Row not deleted");
